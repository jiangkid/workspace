...
class GBRBM(RBM):
    ...
    def get_active(self):
        pre_activation, activation = self.propup(self.input)
        return activation
    ...
    def get_cost_updates(self, batch_size = 128, lr = 0.0001, momentum=0.5, weight_cost=0.0002, persistent=None, k = 1):
